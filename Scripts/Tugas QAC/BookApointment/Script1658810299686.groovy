...
WebUI.setText(findTestObject('CURA Healthcare/Page_CURA Healthcare Service/input_Username_username_1'), 'John Doe')
...
if (RadBut == 1) {
    WebUI.click(findTestObject('CURA Healthcare/Page_CURA Healthcare Service/input_None_programs'))
} else if (RadBut == 2) {
    WebUI.click(findTestObject('CURA Healthcare/Page_CURA Healthcare Service/input_Medicaid_programs'))
}
