...
captcha = WebUI.getAttribute(findTestObject('Object Repository/TAJALAPAK/BACKEND/Page_Administrator  Log In/img'), 'src')

WebUI.setText(findTestObject('Object Repository/TAJALAPAK/BACKEND/Page_Administrator  Log In/input_ADMIN_security_code'), 
    'ZT6SE')
